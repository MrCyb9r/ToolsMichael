...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  MICHAEL YOSAFAT  "$i"                    "
echo $i""$pu"  Name : Mr. CYB9R"$i"                "
echo $i""$pu"  GMAIL   :  rifaelmnrg@gmail.com"$i"     "
echo $i""$pu"  YOUTUBE :  Michael Yosafat"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Michael Yosafat"
echo $ku"YouTube  :"$i" Michael Yosafat"
echo $ku"NAME :"$i" Mr CYB9R"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Michael Yosafat }"
exit
fi
